					...
					<div class="row">
                      ...
                      <input type="hidden" name="id_bukutanah" value="<?= $bkt["id_bukutanah"] ?>">
											<div class="col-md-6 col-sm-6 ">
												<input type="text" class="form-control col-5" name="kd" placeholder="<?= $bkt["id_bukutanah"] ?>">
											</div>
										</div>
										<div class="item form-group">
                  ...
                  <div class="x_content">
                      <div class="row">
                          <div class="col-sm-12">
                            <div class="card-box table-responsive">
                              <div class="col-md-3">
                            <button type="submit" data-toggle="tooltip" data-placement="top" name="excel" title="Excel" class="btn btn-info"><i class="fa fa-plus-square"><a href="laporan_bukutanah.php"> Unduh Excel</a></i>
                    ...
                    $no = 1; ?>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                            <a  href="pengambilan.php?id_bukutanah=<?php echo $d['id_bukutanah'];?>" data-toggle="tooltip" data-placement="top" title="Ambil" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                            <a href="edit.php?id_bukutanah=<?php echo $d['id_bukutanah'];?>" data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-info"><i class="fa fa-edit"></i></a>
                            <a href="form_edit.php?id_bukutanah=<?php echo $d['id_bukutanah'];?>" data-toggle="tooltip" data-placement="top" title="Delete" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                        </div>
                    </td>
                    </tr>
                    <?php endforeach; ?>
