				...
				<div class="">
					...
					<div class="row">
                      ...
                      <label class="col-form-label col-md-2 col-sm-3 label-align" for="cari_hak">Kode Buku Tanah</label>
                        ...
                        <input class="form-control col-3" name="id_hak" list="hak">
                    ...
                    <div class="item form-group">
                        ...
                        <input class="form-control col-3" name="id_desa" list="desa">
          ...
          <div class="clearfix"></div>
                  ...
                  <div class="x_content">
                    ...
                    $no = 1; ?>
                      ...
                      <tr>
                      <!-- <td><input type="checkbox" id="check-all" name="id_bukutanah" value="<?php echo $d['id_bukutanah']?>" ></td> -->
                      <td><?php echo $no++?></td>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                            <a href="pengambilan.php?id_bukutanah=<?php echo $d['id_bukutanah'];?>" data-toggle="tooltip" data-placement="top" name="ambil" title="Ambil" class="btn btn-warning"><i class="fa fa-send"></i></a>
                            <a href="update.php?id_bukutanah=<?php echo $d['id_bukutanah'];?>" data-toggle="tooltip" data-placement="top" name="edit" title="Edit" class="btn btn-info"><i class="fa fa-edit"></i></a>
                            <a href="hapus.php?id_bukutanah=<?php echo $d['id_bukutanah'];?>" onclick="return confirm('YAKIN INGIN MENGHAPUS DATA?');" name="hapus" data-toggle="tooltip" data-placement="top" title="Delete" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                        </div>
                    </td>
                    </tr>
                    <?php endforeach; ?>
