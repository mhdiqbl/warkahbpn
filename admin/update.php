        ...
        <div class="right_col" role="main">
          ...
          <div class="clearfix"></div>
					<div class="row">
                      ...
                      <input type="hidden" name="kd" value="<?= $bkt["id_bukutanah"] ?>">
											<div class="col-md-6 col-sm-6 ">
												<input type="text" class="form-control col-5" name="id_bukutanah" value="<?= $bkt["id_bukutanah"] ?>">
											</div>
										</div>
										<div class="item form-group">
                    ...
                    <br>
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-4">
												<button type="submit" name="ubah" class="btn btn-info"><i class="fa fa-send"> Update</i></button>
											</div>
										 </div>
                  </form>
                </div>
