                      ...
                      <div class="row">
                          <div class="col-sm-12">
                            <div class="card-box table-responsive">
                              <div class="col-md-3">
                            <button type="submit" data-toggle="tooltip" data-placement="top" name="excel" title="Excel" class="btn btn-info"><i class="fa fa-download"><a href="laporan_bukutanah.php"> Unduh Excel</a></i>
